...
<table border="4" 
			 ...
			 <tr> <th>Sender id</th><th>Subject</th><th>Message</th><th>date Of Message</th></tr>
			 
			 
			 
			 
<%
			String strsql = "select * from inbox,login where inbox.receiverid=login.userid";

				ResultSet rsdata = CrudOperation.getData(strsql);
				if (rsdata.next()) {
					String sid  = rsdata.getString("senderid");
					String sub = rsdata.getString("subject");
					 String message = rsdata.getString("message"); 
					 Date date = rsdata.getDate("dateofmsg"); 
		...
		%>
			...
			<tr >
				...
				<th style="font-size: 20px;"><%=sub%></th>
